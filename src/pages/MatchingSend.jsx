...
export default function MatchingSend() {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post("https://hyeonjo.shop/api/matching", formData, {
        headers: {
          ...
          {selectedImages.map((image, index) => (
            <div key={index} className="matching-image-preview">
              ...
              <img
                ...
                className="matching-selected-image"
              />
            </div>
          ))}
          <label className="matching-image-label">이미지 추가하기</label>
          <input
            id="imageInput"
            type="file"
            accept="image/*"
