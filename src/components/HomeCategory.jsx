        ...
        <div className="Category-Container-Wrapper">
          <div className="Category-Container">
            <div className="Category-Wrap">
              <Link className="Category-Button" to="/Category" state={{ selectedCategory: '식사' }}>식사
                <div>
            ...
            <div className="Category-Wrap">
              <Link className="Category-Button" to="/Category" state={{ selectedCategory: '운동' }}>운동
                <div>
                  <img src="/Arrow.png" alt="로고" />
                </div>
              </Link>
            ...
            <div className="Category-Wrap">
              <Link className="Category-Button" to="/Category" state={{ selectedCategory: '공연' }}>공연
                <div>
                  <img src="/Arrow.png" alt="로고" />
                </div>
              </Link>
            ...
            <div className="Category-Wrap">
              <Link className="Category-Button" to="/Category" state={{ selectedCategory: '취미' }}>취미
                <div>
                  <img src="/Arrow.png" alt="로고" />
                </div>
              </Link>
